...
### 나. 배경
- 생성형 AI 대중화 → 책임·편향·안전 문제 표면화, **AI 기본법·EU AI Act** 등 규제 강화
...
flowchart TB
  ...
  style AI fill:#e8f0fe,stroke:#2f6fed,stroke-width:2px
```
...
| 구분 | 이슈 | 해결 방안 |
|---|---|---|
| **법적** | 사고 책임소재 불명확, 학습데이터 저작권, 개인정보 침해 | AI 기본법·규제 준수, 책임체계 정립, 데이터 적법성 확보 |
...
| 방안 | 내용 |
|---|---|
| **AI 거버넌스** | 개발·운영 전주기 책임·윤리 체계, 영향평가 |

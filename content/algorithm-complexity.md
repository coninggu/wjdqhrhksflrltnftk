...
### 가. 정의
> **알고리즘 복잡도**는 입력 크기(n)에 따른 자원 소모량으로, **시간 복잡도**(연산 횟수)와 **공간 복잡도**(메모리)로 구분한다. **O-Notation(빅오)** 은 입력이 커질 때의 **최악의 증가율(점근적 상한)** 을 표기한다.

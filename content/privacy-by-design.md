...
### 가. 정의
> Ann Cavoukian이 창안한, 시스템·서비스 **설계 단계부터 프라이버시를 선제적으로 내재화**하는 개인정보 보호 방법론. GDPR 등 다수 국가 정책에 반영.
...
- 공통점: **최소수집·목적제한·안전성·투명성·책임성**을 설계에 반영
